...
dim(param.inn)
head(param.inn)
write.table(param.inn, file = '2_param.txt', quote = FALSE, row.names = TRUE, col.names = FALSE, sep = ' ')
...
dim(param)
head(param)
write.table(param, file = '3_param.txt', quote = FALSE, row.names = TRUE, col.names = FALSE, sep = ' ')
